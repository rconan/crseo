...
#[doc = " other resources to perform the requested operation."]
...
#[doc = " ::cudaComputeModeProhibited, ::cudaComputeModeExclusiveProcess, or when long"]
...
#[doc = " user allocations. Note that ::cudaDeviceSynchronize made from device"]
#[doc = " runtime is only supported on devices of compute capability < 9.0."]
...
#[doc = " unsupported call to cudaDeviceSynchronize."]
...
#[doc = " would discard semantically important information. This is either due to"]
#[doc = " the object using funtionality newer than the API version used to"]
#[doc = " introspect it or omission of optional return arguments."]
